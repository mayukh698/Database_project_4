...
<head>
 ...
 <style>
 body{
 background-image: url('/database_project/scripts/images/about.jpg');
 opacity: 0.8;
...
<!-- 
<div class="main" style="background-image: url('/database_project/scripts/images/about.jpg');opacity: 0.8;">
 -->
